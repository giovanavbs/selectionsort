...
1- ./selectionsort_aut ou ./selectionsort
...
o selectionsort.c pede a quantidade de elementos e a quantidade de vezes que quer executar(ex: 500 elementos, 1000 vezes) e salva apenas os arquivos dessa execução no arquivo final.
